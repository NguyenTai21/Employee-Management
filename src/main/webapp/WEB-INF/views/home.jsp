                        ...
                        <div class="xp-searchbar">
                                ...
                                <div class="input-group">
                                  ...
                                  <div class="input-group-append">
                                    <button class="btn" onclick="findemp()"
                    ...
                    <div class="col-10 col-md-6 col-lg-8 order-1 order-md-3">
                        ...
                        <ul class="nav navbar-nav flex-row ml-auto">   
                            <li class="dropdown nav-item active">
                                ...
                                <span class="page-title">Hello <%=username %> </span>
    ...
    <table class="table table-striped table-hover">
      ...
      <c:forEach items="${empList}" var="e">
       <tr>
          ...
          <td>${e.getDept() }</td>
          <td>
            <a onclick="getIdForUpdate(${e.eno})" href="#editEmployeeModal"  class="edit" data-toggle="modal">
...
html+="<tr><td>"+data[i].eno+"</td><td>"+data[i].ename+"</td><td>"+data[i].email+"</td><td>"+data[i].address+"</td><td>"+data[i].phone+"</td><td>"+data[i].dept+"</td><td><a onclick=\"getIdForUpdate("+data[i].eno+")\" href=\"#editEmployeeModal\" class=\"edit\" data-toggle=\"modal\"><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Edit\">&#xE254;</i></a><a href=\"/delete?eno="+data[i].eno+"\" class=\"delete\"><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Delete\">&#xE872;</i></a></td>";
